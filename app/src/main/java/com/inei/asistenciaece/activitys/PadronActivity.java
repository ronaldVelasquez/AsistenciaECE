                ...
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, ConstantsUtils.URL_PADRON, new JSONObject(parameters), new Response.Listener<JSONObject>() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        if (volleyError instanceof NoConnectionError){
                            Toast.makeText(PadronActivity.this, "No hay conexi�n a Internet", Toast.LENGTH_SHORT).show();
                        } else if (volleyError instanceof NetworkError) {
                            Toast.makeText(PadronActivity.this, "No hay una buena conexi�n de Internet, Intentelo nuevamente", Toast.LENGTH_SHORT).show();
                        } else {
